    ...
    <nav className="px-4 py-2   xl:px-[2.75rem] xl:py-[0.5rem] w-auto top-0 left-0  ">
      <div className="relative sm:px-6 lg:pl-[6rem]">
        <div className="flex items-center mr-2 justify-between">
          <div className="flex flex-shrink-0 items-center ">
            <a href="/" className=" ">
              <img
                className="flex inset-x-0 left-0 h-14 md:h-14 lg:h-auto"
                src="image/logo.png"
                alt=""
              />
            </a>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center  sm:hidden  ">
            ...
            <button
              onClick={onClickMenu}
              type="button"
              className="inline-flex md:hidden items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
              ...
              <div className="flex whitespace-nowrap md:space-x-1 lg:space-x-3">
                ...
                <div className="mega-menu flex">
                  <a
                    href="#"
                    onClick={showMenu}
                    className="active:text-red-500 text-black-300 font-[800] px-1  lg:px-3 py-2 rounded-md text-sm "
                  >
                    Furniture
                  </a>
                  {/* <img src="image/dropdown-img.jpg" alt="" */}
                  {showMenufurniture ? (
                    <div className="dropdwon-content container  w-[70%] bg-white absolute  top-20  left-[50%] -translate-x-[50%] z-[1]  rounded overflow-hidden">
                      <div className="w-auto">
                        <div className="flex w-auto  items-center justify-between h-auto">
                          {Menus.filter((i) => i.megaMenu)[0].subMenu.map(
                            (data, index) => {
                              return (
                                <button
                                  key={index}
                                  onClick={() => selectMenuFun(index)}
                                  className="text-[10px] md:px-1 whitespace-normal xl:whitespace-nowrap lg:text-[0.8rem] 2xl:text-[1rem] 2xl:px-[0.6rem] mt-[0.5rem] 2xl:ml-[0.4rem] font-[600] text-[#4a6021] mb-[5px] xl:mb-[10px]"
                                >
                                  {data.F_Type}
                                </button>
                              );
                        ...
                        <ul>
                          {Menus.filter((i) => i.megaMenu)[0].subMenu[
                            selectMenu
                          ].content.map((data, index) => {
                            return (
                              <li key={index} className="pl-6 xl:mb-[5px]">
                                <a
                                  href={data.url}
                                  className="text-[8px] lg:text-[0.8rem] text-[#777777] font-[400]"
                                >
                                  {data.nameContent}
                                </a>
                              </li>
                ...
                <a
                  href="#"
                  onClick={() => Navigate("/interiorservice")}
      ...
      >
        {!open ? (
          ...
          <div className="space-y-1 px-2 pt-2 pb-3 absolute rounded-lg bg-[#f8f8f7] z-20 w-[100%] mt-3">
            <a
              href="#"
                ...
                {!showMenufurniture ? (
                  ...
                  <div>
                    <Select
                      ...
                      className="text-lg font-[500]  mb-[0.5rem] bg-transparent "
                    />
                      ...
                      {Menus.filter((i) => i.megaMenu)[0].subMenu[
                        ...
                        return (
                          <li key={index} className="mb-[5px] ">
                            <a
                              href={data.url}
                              className="text-[12px] text-base pl-3 text-[#444343] font-[400]"
                            >
                              {data.nameContent}
                            </a>
                          </li>
