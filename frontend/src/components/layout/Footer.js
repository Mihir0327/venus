          ...
          <div className="top-box row items-center pb-[80px] border-b border-[#858585]">
            ...
            <div className="right col-md-3">
              <div className="button ">
                <a href="#"
                  className=" px-[20px] py-[10px] bg-transparent border border-white text-white font-[600] text-[18px] inline-block  mb-[15px] mt-[15px]"><i
                    className="fa-solid fa-location-dot "></i> Get directions</a>
              </div>
