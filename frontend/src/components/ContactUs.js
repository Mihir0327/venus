  ...
  const handleSend = async (e) => {
    ...
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_API}/api/v1/auth/contactus`,
              ...
              <div className="shrink-0 lg:ml-[3rem] mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
                <form onClick={handleSend}>
                  ...
                  <div className="form-group form-check mb-6">
                    ...
                    />
                    <label className="ml-[1.2rem] text-lg font-medium text-black-800">
          ...
          <section className="relative z-[1] w-full">
            <div className="box">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1836.0123770995563!2d72.5066965!3d23.0228633!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e85a36b4f2bed%3A0x7956d55ffa14893c!2sGlysis%20Software%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1676465996954!5m2!1sen!2sin"
                width="100%"
                height="400px"
