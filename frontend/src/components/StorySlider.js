        ...
        <div className="overflow-hidden">
          <div className="inner-box row">
            <div className="title col-md-3 bg-black p-[20px] pl-[40px]">
              <h2 className="text-[30px] font-[600]   my-[25px] text-[#4a6021]">
                OUR PROJECT
              </h2>
              <p className="text-[#858585]">
                Our team is widely known for the highest quality of the products
                we provide. You can rely on us whether you need a cabinet or
              ...
              <Slider {...settings}>
                <div className="item  relative">
                  ...
                  <div className="story-title absolute left-0 bottom-[-30%] p-[15px] bg-[#00000070] w-full">
                    <h3 className="text-[25px] text-[600] text-white mb-[10px]">
                      Gunpowder Bar & Kitchen
                    </h3>
