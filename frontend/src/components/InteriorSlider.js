  ...
  return (
    <section className="container interior">
      <div className="title text-center">
        <h2 className="text-[25px] font-[700] mb-[5px] md:text-[35px]">
          INTERIOR IDEAS
        </h2>
        <p className="text-[#7a7979] text-[15px] mb-[20px] md:text-[20px]">
      ...
      <div className="interior-slider" id="interior-slider">
        ...
        <div className="button w-max mx-auto pt-[60px] ">
          <a
            href="#"
            className="px-[15px] py-[8px] bg-[#4a6021] text-white font-[600] text-[17px]"
          >
            View Store
          </a>
        </div>
